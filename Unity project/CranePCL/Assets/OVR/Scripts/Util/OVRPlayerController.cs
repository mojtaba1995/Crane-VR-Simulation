...
public class OVRPlayerController : MonoBehaviour
{
	...
	int viewT = 0;
	Transform root1;
	Transform centerEye1;
	Vector3 InitLocalpos = new Vector3(); 
...
//		/// navid
//		/// </summary>
		InitLocalpos =  cam1.transform.localPosition;
		Initpos = cam1.transform.position;
//		 root1 = CameraRig.trackingSpace;
//		 centerEye1 = CameraRig.centerEyeAnchor;
	}
